...
<html lang="en">
  ...
  <body>
    <nav class="nav-menu">
      <div class="container">
        <div class="logo">
          <a href="#"><img class="img-responsive" src="/public/img/logo2.png"></a>
        </div>
        <div class="menu">
          <ul class="phones">
            <li>+7 708 9731440</li>
    ...
    <div class="services" id="services">
      <div class="h3">ДОПОЛНИТЕЛЬНЫЫЕ УСЛУГИ ЦЕНТРА "АЙКУНЕ"</div>
    ...
    <div class="tab-content container">
      ...
      <div role="tabpanel" class="tab-pane" id="refa"><br><br>
        ...
        <div class="col-md-6">
          <p>Прибор для ухода за кожей лица и тела с платиновым и алмазным покрытием. Способствует омоложению, разглаживанию морщин и лифтингу кожи. Уникальный метод массажа крутящимися роликами позволяет увидеть результат уже после 5 минут массажа. Встроенная в ручку массажера панель, принимая солнечные лучи, создает ток низкой частоты. Микротоковая терапия способствует улучшению микроциркуляции крови, регенерации клеток. Благодаря этому происходит образование новых эластиновых и коллагеновых волокн. Морщины разглаживаются и коже возвращается эластичность, улучшается цвет и внешний вид.</p>
          <p>Прибор существует 3х видов: ReFa active, ReFa carat и ReFa. Разница в размере.<br><br> Подробнее на сайте <a href="http://kjstyle.kz/">kjstyle.kz</a></p>
        </div>
      </div>
